...
* **PCA Denoising:** Reducing embedding dimensions from 768 to 128 actually **improved** retrieval performance (MRR 0.143 → 0.148), suggesting that PCA helps remove syntactic noise from the latent space.
